...
set clk_sdram_device {sdram_pll_inst|altpll_component|auto_generated|pll1|clk[0]}
set clk_sdram_ctrl {sdram_pll_inst|altpll_component|auto_generated|pll1|clk[1]}
set clk_audio {audio_pll_inst|altpll_component|auto_generated|pll1|clk[0]}
create_clock -name clk_audcnt -period 162.76 [get_registers {AUDIO_ctrl:AU|oAUD_BCK}]
create_clock -name clk_i2c -period 2500Hz [get_registers {I2C_AV_Config:DACConfU|mI2C_CTRL_CLK}]
